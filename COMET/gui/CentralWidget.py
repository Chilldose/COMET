...
class DetachableTabWidget(QtWidgets.QTabWidget):
    def __init__(self, parent=None):
        """Detatchable QTabWidgets.
        Original solution by: https://stackoverflow.com/a/50693795/3620725
        Refractored by: https://stackoverflow.com/questions/47267195/in-pyqt-is-it-possible-to-detach-tabs-from-a-qtabwidget"""
...
class CentralWidget(DetachableTabWidget):
