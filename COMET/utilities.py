...
class table_control_class:
    ...
    def move_to_strip(self, pad_file, strip, transfomation_class, T, V0, height_movement, **kwargs):
        ...
        if transformation != []:
            if not self.__already_there(pad_file, strip, transfomation_class, T, V0, skip=False): # This skip must alwasy be false, only set it to true if you know what you doin
