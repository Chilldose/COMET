...
class P3Main_window(
    Environement_widget, SettingsControl_widget, Controls_widget, settings_widget
):
    def __init__(self, GUI, layout):
        ...
        self.job = measurement_job_generation(
            self, self.variables.default_values_dict, self.variables.message_from_main
        )
    ...
    def update_settings(self):
        ...
        self.load_new_values(
            "IV_measure",
            self.gui.doIV_checkBox_2,
            self.gui.max_voltage_2,
