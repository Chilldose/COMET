...
class QTCMain_window(
    Environement_widget, Controls_widget, SettingsControl_widget, Table_widget
):
    def __init__(self, GUI, layout):
        ...
        self.child_layouts = {
            "Environment": self.gui.environement_control_layout,
        ...
        if self.variables.default_values_dict["settings"]["new_data"]:
            if len(self.variables.meas_data["CV"][0]) == len(
                ...
                self.cv_plot.plot(
                    ...
                    list(map(self.depletion_volt, self.variables.meas_data["CV"][1])),
                    pen="y",
                    clear=True,
                )
