# A small app which loads the correct settings for the setup.
# You can choose from every setup configured in the configs directory
...
def Loadmain():
    """This function looks if settings have already been done,
    otherwise it configs everything and starts the env"""
